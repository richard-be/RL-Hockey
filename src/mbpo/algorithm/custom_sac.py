...
class SAC(object):
    def __init__(self, num_inputs, action_space, args):
        ...
        print(args)
        print("Using different LR for critic and actor:")
        print("Critic:", args.lr_q)
        print("Actor:", args.lr)

        self.critic = QNetwork(num_inputs, action_space.shape[0], args.hidden_size).to(
            device=self.device
        )
        self.critic_optim = Adam(self.critic.parameters(), lr=args.lr_q)
        ...
        if self.policy_type == "Gaussian":
            ...
            if self.automatic_entropy_tuning is True:
                ...
                self.alpha_optim = Adam([self.log_alpha], lr=args.lr_q)
